...
#[derive(Debug)]
pub struct ListVaultProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ListVaultProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ListVault processing");
    
    let mut processor = ListVaultProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ListVaultProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ListVaultProcessor::new(false);
